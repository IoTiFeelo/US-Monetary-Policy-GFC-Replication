...
SVAR fraamework. This result follows from invertibility of $\varepsilon$
and two assumptions: 
...
```{r}
  ...
  mtext("Posterior Parameters for Basic and Extended Models", side=3, line=-2, outer = TRUE)
...
abline(v = mean(extended.artificial$k.sigma.convergence), col='blue3', lwd = 3)
```
# References
:::
