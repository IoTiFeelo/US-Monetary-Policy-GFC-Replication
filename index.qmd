...
```{r package load2}
#"INDPRO" <- "Industrial Production"; "PCEPI" <- "PCE Deflator"; "BISREER" <- "BIS Real EER";  "DGS1" <- "1Y Treasury Rate"; "GLOBALRA" <- "Global Risk Aversion"; "EUBDLEV" <- "Leverage EU Global Banks"; "USBANKSL" <- "Leverage US Banks"; "EUBANKSL" <- "Leverage EU Banks"; "GLBINFLALL" <- "Global Inflows All Sectors"; "GLBINFLB" <- "Global Inflows to Banks"; "GLBINFNB" <- "Global Inflows to Non-Banks"; "GLBCREDIT" <- "Global Domestic Credit"; "GLBCREXUS" <- "Global Domestic Credit Ex US"; "GREA" <- "Global Real Economic Activity"; "GREAEXUS" <- "Global Real Economic Activity Ex US"; "NONREVSL" <- "US Total Non-revolving Credit"; 
"GLOBAL FACTOR 1990-2012" <- "Global Factor"
library(ggplot2)
...
#plot(x=data$LABEL, y=cbind(leverage_vars, inflows_vars, domestic_vars, other_vars))
```
